...
const u8 gText_BirchInTrouble[] = _("Choose a Pokémon to battle with!");
...
const u8 gText_ThrowInPremierBall[] = _("I threw in a Premier Ball as an added\nbonus.{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBalls[] = _("I threw in {STR_VAR_1} Premier Balls as an added\nbonus.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 2}{DYNAMIC 5} nature, caught in\n{DYNAMIC 4} at {LV_2}{DYNAMIC 3}");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 2}{DYNAMIC 5} nature, hatched\nat {DYNAMIC 4}");
...
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 2}{DYNAMIC 5} nature, possibly\n{FONT_NARROW}met in {DYNAMIC 4} at {FONT_NORMAL}{LV_2}{FONT_NARROW}{DYNAMIC 3}{FONT_NORMAL}");
