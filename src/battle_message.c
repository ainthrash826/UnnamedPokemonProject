...
static const u8 sText_WildPkmnAppeared[] = _("{PAUSE 38}You encountered a wild {B_OPPONENT_MON1_NAME}!\p");
static const u8 sText_WildPkmnFromChestAttacked[] = _("{PAUSE 38}The {B_OPPONENT_MON1_NAME} inside the chest attacked!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("{PAUSE 38}You encountered {B_OPPONENT_MON1_NAME}!\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{PAUSE 38}Prof. Watson: Ah, A wild {B_OPPONENT_MON1_NAME} appeared!\pNow here's the fun part! You have to weaken the Pokémon before throwing a Poké Ball!\p");
static const u8 sText_TwoWildPkmnAppeared[] = _("{PAUSE 38}You encountered a wild {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME}!\p");
static const u8 sText_GhostAppearedCantId[] = _("{PAUSE 38}The GHOST appeared!\pDarn!\nThe GHOST can't be ID'd!\p");
static const u8 sText_TheGhostAppeared[] = _("{PAUSE 38}The GHOST appeared!\p");
static const u8 sText_Trainer1WantsToBattle[] = _("{PAUSE 38}You are challenged by {B_TRAINER1_NAME_WITH_CLASS}!\p");
...
static const u8 sText_LinkPartnerSentOutPkmn2GoPkmn[] = _("Go, {B_LINK_PLAYER_MON1_NAME}! {B_LINK_PARTNER_NAME} sent out {B_LINK_PLAYER_MON2_NAME}!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{PAUSE 180}{PLAY_BGM MUS_VICTORY_WILD}\p"),
    [STRINGID_GOTCHAPKMNCAUGHTWALLY]                = COMPOUND_STRING("Gotcha! {B_DEF_NAME} was caught!{PAUSE 180}{PLAY_BGM MUS_VICTORY_WILD}{PAUSE 60}"),
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("Alright, the Pokémon's HP is low! It's time to throw a Poké Ball!"),
    ...
    [STRINGID_SENDCAUGHTMONPARTYORBOX]              = COMPOUND_STRING("Where should {B_DEF_NAME} go?"),
...
const u8 gText_BattleSendMonChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}{FONT_NARROW}Party\nBoxes");
...
static const u8 sText_TwoTrainersWantToBattle[] = _("{PAUSE 38}You are challenged by {B_TRAINER1_NAME_WITH_CLASS} and {B_TRAINER2_NAME_WITH_CLASS}!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("Go, {B_PLAYER_MON1_NAME}! {B_PARTNER_NAME_WITH_CLASS} sent out {B_PLAYER_MON2_NAME}!");
...
void BufferStringBattle(enum StringID stringID, enum BattlerId battler)
{
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            ...
            else if (FlagGet(FLAG_TEMP_10))
                stringPtr = sText_WildPkmnFromChestAttacked;
