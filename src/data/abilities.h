...
const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    [ABILITY_NONE] =
    {
        ...
        .shortDesc = COMPOUND_STRING("No Ability."),
        .aiRating = 0,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
    },
    ...
    [ABILITY_STENCH] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Moves may cause flinching."),
        .aiRating = 1,
    },
    ...
    [ABILITY_SPEED_BOOST] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Speed raises every turn."),
        .aiRating = 9,
    },
    ...
    [ABILITY_CHLOROPHYLL] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Boosts Speed in sunlight."),
        .aiRating = 6,
    },
    ...
    [ABILITY_OVERGROW] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Ups Grass moves at low HP."),
        .aiRating = 5,
    },
    ...
    [ABILITY_BLAZE] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Ups Fire moves at low HP."),
        .aiRating = 5,
    },
    ...
    [ABILITY_TORRENT] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Ups Water moves at low HP."),
        .aiRating = 5,
    },
    ...
    [ABILITY_SWARM] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Ups Bug moves at low HP."),
        .aiRating = 5,
    },
    ...
    [ABILITY_PICKPOCKET] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Steals the foe's item if hit."),
        .aiRating = 3,
    },
    ...
    [ABILITY_BIG_PECKS] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Defense can't be lowered."),
        .aiRating = 1,
        .breakable = TRUE,
    },
    ...
    [ABILITY_SEED_SOWER] =
    {
        ...
        .shortDesc = COMPOUND_STRING("Makes field grassy if hit."),
        .aiRating = 5,
    },
