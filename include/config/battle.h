...
#define B_RETURN_STOLEN_NPC_ITEMS   FALSE      // In Gen5+, Thief and Covet no longer permanently steal items from NPCs.
...
#define B_WAIT_TIME_MULTIPLIER              4          // This determines how long text pauses for in battle. Vanilla is 16. Lower values result in faster battles.
