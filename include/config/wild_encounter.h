...
#define WE_FLAG_NO_ENCOUNTER        FLAG_ADVENTURE_STARTED       // If this flag is set, wild encounters will be disabled.

// Double Wild Battles
#define WE_DOUBLE_WILD_CHANCE            15          // % chance of encountering two Pokémon in a Wild Encounter.
