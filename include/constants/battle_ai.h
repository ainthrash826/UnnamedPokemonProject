...
//#define AI_FLAG_TRAINER_PLUS          (AI_FLAG_BASIC_TRAINER | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING)
//#define AI_FLAG_GYM_LEADER            (AI_FLAG_TRAINER_PLUS | AI_FLAG_ACE_POKEMON)
...
#define AI_FLAG_TRAINER_PLUS          (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_HP_AWARE | AI_FLAG_SMART_SWITCHING)
#define AI_FLAG_GYM_LEADER            (AI_FLAG_TRAINER_PLUS | AI_FLAG_ACE_POKEMON)
#define AI_FLAG_SMART_TRAINER         (AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_SMART_TERA | AI_FLAG_RANDOMIZE_SWITCHIN)
